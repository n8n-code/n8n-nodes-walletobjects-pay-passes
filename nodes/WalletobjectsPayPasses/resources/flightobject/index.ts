...
export const flightobjectDescription: INodeProperties[] = [
		{
			...
			"options": [
				{
					"name": "Walletobjects Flightobject List",
					"value": "Walletobjects Flightobject List",
					"action": "Walletobjects Flightobject List",
					"description": "Returns a list of all flight objects for a given issuer ID.",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/walletobjects/v1/flightObject"
						}
					}
				},
				{
					"name": "Walletobjects Flightobject Insert",
					"value": "Walletobjects Flightobject Insert",
					"action": "Walletobjects Flightobject Insert",
				...
				{
					"name": "Walletobjects Flightobject Get",
					"value": "Walletobjects Flightobject Get",
					"action": "Walletobjects Flightobject Get",
					"description": "Returns the flight object with the given object ID.",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/walletobjects/v1/flightObject/{{$parameter[\"resourceId\"]}}"
						}
					}
				},
				{
					"name": "Walletobjects Flightobject Patch",
					"value": "Walletobjects Flightobject Patch",
					"action": "Walletobjects Flightobject Patch",
				...
				{
					"name": "Walletobjects Flightobject Update",
					"value": "Walletobjects Flightobject Update",
					"action": "Walletobjects Flightobject Update",
				...
				{
					"name": "Walletobjects Flightobject Addmessage",
					"value": "Walletobjects Flightobject Addmessage",
					"action": "Walletobjects Flightobject Addmessage",
					"description": "Adds a message to the flight object referenced by the given object ID.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/walletobjects/v1/flightObject/{{$parameter[\"resourceId\"]}}/addMessage"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /walletobjects/v1/flightObject",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /walletobjects/v1/flightObject",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Boarding And Seating Info",
			"name": "boardingAndSeatingInfo",
			"type": "json",
			"default": "{\n  \"boardingPrivilegeImage\": {\n    \"contentDescription\": {\n      \"defaultValue\": {},\n      \"translatedValues\": [\n        {}\n      ]\n    },\n    \"sourceUri\": {\n      \"localizedDescription\": {}\n    }\n  },\n  \"seatAssignment\": {}\n}",
			"description": "Passenger specific information about boarding and seating.",
			"routing": {
				"send": {
					"property": "boardingAndSeatingInfo",
					"propertyInDotNotation": false,
					"type": "body",
					"value": "={{ JSON.parse($value) }}"
				}
		...
		{
			"displayName": "Security Program Logo",
			"name": "securityProgramLogo",
			"type": "json",
			"default": "{\n  \"contentDescription\": {\n    \"defaultValue\": {},\n    \"translatedValues\": [\n      {}\n    ]\n  },\n  \"sourceUri\": {\n    \"localizedDescription\": {}\n  }\n}",
			"description": "Wrapping type for Google hosted images. Next ID: 7",
			"routing": {
				"send": {
					"property": "securityProgramLogo",
					"propertyInDotNotation": false,
					"type": "body",
					"value": "={{ JSON.parse($value) }}"
				}
		...
		{
			"displayName": "GET /walletobjects/v1/flightObject/{resourceId}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "PATCH /walletobjects/v1/flightObject/{resourceId}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "PUT /walletobjects/v1/flightObject/{resourceId}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /walletobjects/v1/flightObject/{resourceId}/addMessage",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
