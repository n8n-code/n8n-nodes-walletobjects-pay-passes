...
export const giftcardclassDescription: INodeProperties[] = [
		{
			...
			"options": [
				{
					"name": "Walletobjects Giftcardclass List",
					"value": "Walletobjects Giftcardclass List",
					"action": "Walletobjects Giftcardclass List",
					"description": "Returns a list of all gift card classes for a given issuer ID.",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/walletobjects/v1/giftCardClass"
						}
					}
				},
				{
					"name": "Walletobjects Giftcardclass Insert",
					"value": "Walletobjects Giftcardclass Insert",
					"action": "Walletobjects Giftcardclass Insert",
				...
				{
					"name": "Walletobjects Giftcardclass Get",
					"value": "Walletobjects Giftcardclass Get",
					"action": "Walletobjects Giftcardclass Get",
					"description": "Returns the gift card class with the given class ID.",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/walletobjects/v1/giftCardClass/{{$parameter[\"resourceId\"]}}"
						}
					}
				},
				{
					"name": "Walletobjects Giftcardclass Patch",
					"value": "Walletobjects Giftcardclass Patch",
					"action": "Walletobjects Giftcardclass Patch",
				...
				{
					"name": "Walletobjects Giftcardclass Update",
					"value": "Walletobjects Giftcardclass Update",
					"action": "Walletobjects Giftcardclass Update",
				...
				{
					"name": "Walletobjects Giftcardclass Addmessage",
					"value": "Walletobjects Giftcardclass Addmessage",
					"action": "Walletobjects Giftcardclass Addmessage",
					"description": "Adds a message to the gift card class referenced by the given class ID.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/walletobjects/v1/giftCardClass/{{$parameter[\"resourceId\"]}}/addMessage"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /walletobjects/v1/giftCardClass",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /walletobjects/v1/giftCardClass",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Allow Barcode Redemption",
			"name": "allowBarcodeRedemption",
			"type": "boolean",
			"default": true,
			...
			"routing": {
				"send": {
					"property": "allowBarcodeRedemption",
					"propertyInDotNotation": false,
					"type": "body",
					"value": "={{ $value }}"
				}
		...
		{
			"displayName": "Event Number Label",
			"name": "eventNumberLabel",
			"type": "string",
			"default": "",
			"description": "The label to display for event number, such as \"Target Event #\".",
			"routing": {
				"send": {
					"property": "eventNumberLabel",
					"propertyInDotNotation": false,
					"type": "body",
					"value": "={{ $value }}"
				}
		...
		{
			"displayName": "Localized Card Number Label",
			"name": "localizedCardNumberLabel",
			"type": "json",
			"default": "{\n  \"defaultValue\": {},\n  \"translatedValues\": [\n    {}\n  ]\n}",
			"description": "Translated strings for the card_number_label.",
			"routing": {
				"send": {
					"property": "localizedCardNumberLabel",
					"propertyInDotNotation": false,
					"type": "body",
					"value": "={{ JSON.parse($value) }}"
				}
		...
		{
			"displayName": "Localized Event Number Label",
			"name": "localizedEventNumberLabel",
			"type": "json",
			"default": "{\n  \"defaultValue\": {},\n  \"translatedValues\": [\n    {}\n  ]\n}",
			"description": "Translated strings for the event_number_label.",
			"routing": {
				"send": {
					"property": "localizedEventNumberLabel",
					"propertyInDotNotation": false,
					"type": "body",
					"value": "={{ JSON.parse($value) }}"
				}
		...
		{
			"displayName": "Localized Merchant Name",
			"name": "localizedMerchantName",
			"type": "json",
			"default": "{\n  \"defaultValue\": {},\n  \"translatedValues\": [\n    {}\n  ]\n}",
			...
			"routing": {
				"send": {
					"property": "localizedMerchantName",
					"propertyInDotNotation": false,
					"type": "body",
					"value": "={{ JSON.parse($value) }}"
				}
		...
		{
			"displayName": "Localized Pin Label",
			"name": "localizedPinLabel",
			"type": "json",
			"default": "{\n  \"defaultValue\": {},\n  \"translatedValues\": [\n    {}\n  ]\n}",
			"description": "Translated strings for the pin_label.",
			"routing": {
				"send": {
					"property": "localizedPinLabel",
					"propertyInDotNotation": false,
					"type": "body",
					"value": "={{ JSON.parse($value) }}"
				}
		...
		{
			"displayName": "GET /walletobjects/v1/giftCardClass/{resourceId}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "PATCH /walletobjects/v1/giftCardClass/{resourceId}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "PUT /walletobjects/v1/giftCardClass/{resourceId}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /walletobjects/v1/giftCardClass/{resourceId}/addMessage",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
